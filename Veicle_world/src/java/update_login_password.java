 ...
 * @author welcome
 */
public class update_login_password extends HttpServlet {
...
//Connection cn=DriverManager.getConnection("jdbc:mysql://localhost:3306/VLE","root","");
	...
	//Statement smt=cn.createStatement();
     ...
     int i=smt.executeUpdate("Update vehicle set user_password='"+password+"'");
    ...
    {
        out.println("<h1>your password has been updated</h1>");
