 ...
 * @author welcome
 */
public class Add_rentalv_vehicle extends HttpServlet {
	...
	//Statement smt=cn.createStatement();
		...
		//execute query
int i=smt.executeUpdate("insert into rental_vehicle(vehicle_name,vehicle_type,Rent_Rate) values('"+name+"','"+type+"','"+rate+"')");
